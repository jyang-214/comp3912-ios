...
class Search {
  static func searchForStudents(
    list students: [Student], with condition: (Student) -> Bool,
    their specification: (Student) -> String,
...
let specification: (Student) -> String = { student in
  return
    "Email: \(student.getEmail()), GPA: \(student.getGPA()), Age: \(student.getAge()), Courses: \(student.getTakenCourses())"
}
