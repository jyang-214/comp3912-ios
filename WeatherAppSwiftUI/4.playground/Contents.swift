...
let obj1 = MyProtocolConformingClass(property1: 42, property2: "Hello", property3: { value in
    if let value = value {
...
let obj2 = MyProtocolConformingClass(property1: nil, property2: "World", property3: { value in
    if let value = value {
        return "Received value: \(value)"
    } else {
        return "Value is nil"
...
let instance1 = MyClass(property1: 42, property2: "Hello", property3: { intValue in
