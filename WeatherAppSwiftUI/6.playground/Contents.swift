...
private var myViewController: LoginViewController = {
    ...
    guard let myViewController =    // missing 'let' UIStoryboard.myStoryboard.instantiateViewController(withIdentifier: LoginViewController.storyboardIdentifier) as? LoginViewController else {
