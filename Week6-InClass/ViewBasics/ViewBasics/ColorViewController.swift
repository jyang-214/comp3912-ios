...
class ColorViewController: UIViewController{
    ...
    func addTransitionButton(to view: UIView){
    ...
    @objc func navigateToNavigationController(){
            let storyboard = UIStoryboard(name: "Main", bundle: nil) // Replace "Main" with your storyboard name
                let navController = storyboard.instantiateViewController(withIdentifier: "YourNavigationControllerID") as! UINavigationController
